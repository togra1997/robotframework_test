...
def create_sample_data():
    ...
    # 辞書形式のサンプルデータ
    dict_data = [
        {'名前': '田中太郎', '年齢': 25, 'スコア': 1500, 'レベル': 'Easy'},
        {'名前': '佐藤花子', '年齢': 30, 'スコア': 2400, 'レベル': 'Normal'},
        {'名前': '鈴木一郎', '年齢': 22, 'スコア': 3200, 'レベル': 'Hard'},
        {'名前': '高橋美咲', '年齢': 27, 'スコア': 2800, 'レベル': 'Normal'},
        {'名前': '伊藤健太', '年齢': 35, 'スコア': 4100, 'レベル': 'Hard'}
    ]
